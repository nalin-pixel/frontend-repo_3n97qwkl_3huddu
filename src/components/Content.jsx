      ...
      <div className="bg-slate-800/50 border border-blue-400/20 rounded-2xl p-5">
        ...
        {explanation ? (
          <div className="text-blue-100">
            <h4 className="text-xl font-bold mb-2">{explanation.title}</h4>
            <p className="mb-3 text-blue-200/80">{explanation.summary}</p>
          ...
          <div className="space-y-4">
            {practice.problems.map((p)=> (
              <div key={p.id} className="bg-slate-900/60 border border-slate-700 rounded-xl p-4">
                <div className="text-blue-100 font-medium">{p.question}</div>
